...
<body>
	<div class="wrapper">
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="{{ route("private.dashboard") }}" class="logo">
								...
								<li>
									<div class="message-notif-scroll scrollbar-outer">
										<div class="notif-center">
											<a href="#">
												<div class="notif-img"> 
													<img src="{{ asset('private/assets/img/jm_denis.jpg') }}" alt="Img Profile">
												</div>
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="{{ asset('private/assets/img/chadengle.jpg') }}" alt="Img Profile">
												</div>
												<div class="notif-content">
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="{{ asset('private/assets/img/mlane.jpg') }}" alt="Img Profile">
												</div>
												<div class="notif-content">
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="{{ asset('private/assets/img/talha.jpg') }}" alt="Img Profile">
												</div>
												<div class="notif-content">
								...
								<!-- <li>
									<div class="notif-scroll scrollbar-outer">
										<div class="notif-center">
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="{{ asset('private/assets/img/profile2.jpg') }}" alt="Img Profile">
												</div>
												<div class="notif-content">
													<span class="block">
			...
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
					...
					<ul class="nav nav-primary">
						...
						@ican("user.view")
						<li class="nav-item @if($currentUrl == route("private.users")) active @endif">
						...
						@ican("club.view")
						<li class="nav-item @if($currentUrl == route("private.club")) active @endif">
							<a href="{{ route('private.club') }}">
						...
						@ican("event.view")
						<li class="nav-item @if($currentUrl == route("private.events")) active @endif">
						...
						@ican("event.view")
						<li class="nav-item @if($currentUrl == route("private.stickers")) active @endif">
							<a href="{{ route('private.stickers') }}">
						...
						@ican("setting.view")
						<li class="nav-item @if($currentUrl == route("private.employees") || $currentUrl == route("private.admintypes") || $currentUrl == route("private.eventtypes") || $currentUrl == route("private.stickerstype")) active submenu @endif">
							<a data-toggle="collapse" href="#base">
								<i class="fas fa-cog"></i>
								<p>Settings</p>
								<span class="caret"></span>
							</a>
							<div class="collapse @if($currentUrl == route("private.employees") || $currentUrl == route("private.admintypes") || $currentUrl == route("private.eventtypes") || $currentUrl == route("private.stickerstype")) show @endif" id="base">
								<ul class="nav nav-collapse">
									<li class=" @if($currentUrl == route("private.employees")) active @endif">
										<a href="{{ route('private.employees') }}">
											<span class="sub-item">
									...
									@ican("eventType.view")
									<li class=" @if($currentUrl == route("private.eventtypes")) active @endif">
										<a href="{{ route('private.eventtypes') }}">
											<span class="sub-item">
												{{-- <i class="fas fa-user-shield"></i> --}}
												<p>Event Type</p>
											</span>
                                    ...
                                    @ican("eventType.view")
									<li class=" @if($currentUrl == route("private.admintypes")) active @endif">
										<a href="{{ route('private.eventsubcategories') }}">
											<span class="sub-item">
									...
									@endican
									@ican("eventType.view")
									<li class=" @if($currentUrl == route("private.stickerstype")) active @endif">
										<a href="{{ route('private.stickerstype') }}">
											<span class="sub-item">
												{{-- <i class="fas fa-user-shield"></i> --}}
												<p>Sticker Type</p>
											</span>
	...
	@include('private.layouts.includes.modal')

	<script src="{{ asset('js/app.js') }}" ></script>

	<!-- jQuery UI -->
	<script src="{{ asset('private/assets/js/plugin/jquery-ui-1.12.1.custom/jquery-ui.min.js') }}"></script>
	<script src="{{ asset('private/assets/js/plugin/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js') }}"></script>
	
	<!-- jQuery Scrollbar -->
	<script src="{{ asset('private/assets/js/plugin/jquery-scrollbar/jquery.scrollbar.min.js') }}"></script>
	<!-- Bootstrap Notify -->
	...
	<!-- Sweet Alert -->
	<script src="{{ asset('private/assets/js/plugin/sweetalert/sweetalert.min.js') }}"></script>
	...
	<script>
		...
		//Disable Datatable notification
...
{{-- asset('private/assets/img/profile.jpg') --}}