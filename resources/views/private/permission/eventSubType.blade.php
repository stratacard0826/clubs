					...
					<div class="row p-2 filter-cont mb-4">
						<div class="col-md-3 pl-0">
							<div class="form-group pt-0">
								...
								<select class="select-filter form-control" data-placeholder="Select a type" id="type-filter">
					...
					<div class="row">
						...
						<div class="col-sm-12">
							<div class="form-group form-group-default">
								<label>Event Type</label>
								<input id="addName" type="text" maxlength="{{ limit("user_type.max")}}" class="form-control" placeholder="Event Name" name="name">
							</div>
						</div>
                        <div class="col-md-12">
							<div class="form-group form-group-default">
								<label>Event Main Type</label>
					...
					<div class="row">
                        <div class="col-sm-12">
							<div class="form-group form-group-default">
								...
								<input id="editName" type="text" maxlength="{{ limit("user_type.max")}}" class="form-control" placeholder="Event Name" name="name">
							</div>
						</div>
						<div class="col-md-12">
							<div class="form-group form-group-default">
...
@push("js")
	...
	<script type="text/javascript">
		var delete_url = "{{ route('private.eventsubcategory.destroy') }}";
		var table;
		...
		$(document).ready(function() {
	    	...
	    	table = $('#record-table').dataTable({
	            ...
	            "serverSide": true,
	            "ajax": {
	                "url": "{{ route("private.eventsubcategory.list") }}",
	                "type": "POST",
	                data: function (d) {     
	            ...
	            "columns": [
	               ...
	               createdRow: function( row, data, dataIndex ) {
	                              ...
	                              $(row).find( '.status_edit' ).editable({
	                                    url: "{{ route('private.eventsubcategory.status') }}",
	        ...
	        $("#addForm").validate({
	            ...
	            submitHandler: function(form) {
	                ...
	                $.ajax({
	                    type: "POST",
	                    url: "{{ route('private.eventsubcategory.create') }}",
	                    data: data,
	                    dataType: "json",
	        ...
	        $("#editForm").validate({
	            ...
	            submitHandler: function(form) {
	                ...
	                $.ajax({
	                    type: "POST",
	                    url: "{{ route('private.eventsubcategory.update') }}",
	                    data: data,
	                    dataType: "json",
	                    success: function(data) {
	                        loadButton("#editRowButton");
            ...
            $("table").on("click", ".edit-data", function(){
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('private.eventsubcategory.edit')}}",
                    data: {data:dataId},
                    dataType: "json",
                    success: function(response) {
                    	if(response.success == 1){
	                        ...
	                        $('#editModal #editType').val(record.parent_id).trigger("change");
	                        $('#editModal').modal();
	                    }
	                    else
	                    {
