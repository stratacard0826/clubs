...
<div class="page-inner">
	<div class="page-header">
		...
		<ul class="breadcrumbs">
			...
			<li class="nav-item">
				<a href="{{ route('private.admintypes') }}">Admin Type</a>
			</li>
			<li class="separator">
				<i class="flaticon-right-arrow"></i>
			</li>
	                    ...
	                    {   "mRender": function ( data, type, row ) 
	                        {
	                        	var btn = `<div class="form-button-action"> 
		                        				<a href="" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-id="${row.id}" data-original-title="Set Permission" target="_blank"> <i class="fa fa-eye"></i> </a> 
